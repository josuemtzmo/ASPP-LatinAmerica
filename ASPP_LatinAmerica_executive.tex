...
the community of scientists who are \remove{generally} not properly trained for the
creation and maintenance of scientific software. Very often scientists spend
\remove{(waste)} a significant amount \add{of} time writing, maintaining and debugging
sub-optimal self-written code\remove{, o Often reinventing the wheel,} instead of being
...
and sustainable code\change{. with}{This summer school} provides hands-on experience on th\change{e}{ese} subset of \remove{these} techniques \change{that matter most, teaching them clean language design}{as well as, a clear language design}, extensibility of code,
and good practices in scientific computing and data visualization. Each year,
this self funded effort has attracted scientist\add{s} who want to acquire software
engineering skills to tackle new challenges in their areas of expertise\add{.} \remove{for
the  benefit of the scientific community}. The summer school \change {grew} {is growing}quickly, and
...
Asian continent. \note{Would it be good to introduce our idea here? Something like: The success and growing interest in the scientist community in Latin-America encourages to create a new branch following the previous organized schools in Latin-America.}
...
Latin-American scientist \remove{who are directly} working with scientific software
development has dramatically grown in the past few years without any effort of
alleviating \change {such problems.}{the issues previously mention.} For this, we propose the creation of the
...
countries and benefit to the development of the\add{ir} scientific community\remove{ of each
nation}.  We aim to hold the first instance of the school during the month of
July of 2020 in Mexico City \note{I think this line is a bit inappropriate, I will strongly suggest to remove it, perhaps add something like:} \add{due to the interest and support of one of the most prestigious institutions in Latin-America (UNAM), which will facilitate the success of the first ASPP-Latin America} \remove{due to its position as a leading developing country
...
The previous success of the other instances of th\change{e}{is} summer school is very highly
...
school in a \change{remote}{isolated} location in Mexico City in order to create a profound
...
\anotate{During the summer school, we will teach a selection of advanced programming
...
let participants practice the techniques.}{I think this section is a bit repetitive with the 2nd paragraph, potentially you could remove this and only move the next sentence to the 2nd paragraph} All of the newly acquired skills will
...
language a very popular choice in almost any branch of science. \anotate{We show how
...
Python to become a standard tool for the programming scientist.}{A bit repetitive, but I believe it kind of fits well here.}

\section*{Target Audience}
The summer school is targeted \change{at}{to early career researchers} \remove{master or PhD students, as well as post-docs}
...
(700 USD), as well as 2 social events (2,000 USD). Students \add{may ne required to} pay their own
