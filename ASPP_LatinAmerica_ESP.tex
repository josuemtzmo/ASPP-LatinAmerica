...
\section*{Scope}
La escuela de verano Advanced Scientific Programming in Python (ASPP) - Latinoamérica seguirá la estructura y curriculum de las escuelas previamente organizadas en Europa (2008-2019) y la región de Asia-Pacífico (2018, 2019).
Esta exitosa escuela de verano ha mostrado una necesidad por enseñar a científicos los principios de \emph{computo científico e ingeniería de sistemas} en el lenguaje de programación Python. 
El objetivo de éste intenso programa es enseñar técnicas avanzadas de programación, así como las mejores practicas en el desarrollo de software que son estándares para realizar investigación en ciencias naturales y sociales, ingeniería y matemáticas. 
%The goal of this intensive programming workshop is to teach a selection of advanced programming techniques and best practices in  software development which are standard, to researchers in the natural and social sciences, engineering and mathematics.\\

Las herramientas y conceptos introducidos en este taller ayudará a jóvenes investigadores a usar menos tiempo escribiendo, resolviendo problemas del código y entendiendo programas de computación. 
...
Adicionalmente, esperamos que después del curso, participantes serán capaces de contribuir a la comunidad científica de código abierto. 
...
Con tan solo una semana de clases, reconocemos que estos ambiciosos objetivos unicamente serán parcialmente cubiertos.
%With only a week of lectures, we accept that these ambitious goals will be at best partially realized. 
Sin embargo, los participantes serán expuestos a una amplia cantidad de recursos y referencias, que en caso de ser estudiados y practicados, entrenarán a la nueva generación de futuros científicos capaces de escribir mejor códigos y también hacerlo re-usable y fácil de entender en caso de que alguien quiera reproducir sus resultados.
...
\'Este curso consistir\'a en clases y discusiones con una componente practica 
...
Presupuesto dentro de 150000 y 200000 pesos
